...
export function renderResources(): string {
  return html`
      ...
      <div class="container">
        ${raw(
          renderSectionHeader(
            ...
            'green',
            'Resources & Guides',
            'Everything you need to know about your rights, government processes, and how to hold authorities accountable',
          ),
        )}
        <div class="search-bar animate-on-scroll">
          ...
          <input
            type="text"
            id="resource-search"
            placeholder="Search resources, guides, and FAQs..."
    ...
    <section class="section section-alt-bg" aria-label="Frequently Asked Questions">
      <div class="container">
        ${raw(renderSectionHeader('FAQ', 'saffron', 'Frequently Asked Questions'))}
        <div class="animate-on-scroll faq-container">
          ${raw(FAQS.map(f => renderAccordionItem(f.question, f.answer, 'resource-card')).join(''))}
        </div>
      </div>
    </section>
    ...
    <section class="section" aria-label="Glossary">
      <div class="container">
        ${raw(renderSectionHeader('Reference', 'green', 'Glossary of Government Processes'))}
